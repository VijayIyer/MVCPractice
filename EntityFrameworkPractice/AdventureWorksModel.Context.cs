...
namespace EntityFrameworkPractice
{
    ...
    public partial class AdventureWorksEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetCustomeAddressById_Result> GetCustomeAddressById(Nullable<int> customerId)
        {
            var customerIdParameter = customerId.HasValue ?
                new ObjectParameter("CustomerId", customerId) :
                new ObjectParameter("CustomerId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCustomeAddressById_Result>("GetCustomeAddressById", customerIdParameter);
        }
    
        public virtual ObjectResult<InsertAddress_Result> InsertAddress()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<InsertAddress_Result>("InsertAddress");
        }
